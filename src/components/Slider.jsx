  ...
  return (
    <div className="h-full pt-20 bg-[#EDECE7]">
      ...
      <div className="flex justify-end">
        ...
        <img src={uparrow} alt="" className="w-[4vh] ml-10" />        <span className="Actonia text-black mb-auto mr-2 text-4xl">through</span>
