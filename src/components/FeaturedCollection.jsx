...
function FeaturedCollection() {
  return (
    ...
    <div className='h-[70vh] bg-aboutus grid grid-cols-2 gap-1  text-white text-6xl font-extralight font-sans pt-[13vh] pb-20 pl-20'>
      <div className=' h-[60vh] flex flex-row-reverse flex-nowrap'>
      <img src = "src/assets/images/about.svg" alt="hello"/>
      </div>
      <div className="text-5xl uppercase flex-col flex gap-10 pl-10   items-center justify-center">
        <strong>  
        <p>Behind<p></p><div className=" flex-row flex gap-2"> <p className = "Actonia text-5xl mb-auto lowercase ml-10" >the</p> <p className="text-yellow-300"> brand</p></div></p>
